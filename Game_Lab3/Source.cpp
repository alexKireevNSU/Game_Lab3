...
class Main_Sprite_Controller : public Game::Sprite_Controller {
	...
	Uint8 down = 0;
public:
	Main_Sprite_Controller(Sprite* robot_collector, Drawing_Area da) {
...
int main(int argc, char** argv) {
	...
	g.Set_Sprites(robot_collector, background, sprites);


	Game::Sprite_Controller* main_sprite_controller = new Main_Sprite_Controller(robot_collector, da);
	g.mainloop(main_sprite_controller);

	delete main_sprite_controller;
